...
const soluzioni = [
  { label: "Orbis Sistema", href: "/sistema", desc: "Prenotazioni e comunicazioni multicanale" },
  { label: "Orbis Gestionale", href: "/gestionale", desc: "Contabilità, fatturazione e gestione aziendale" },
];
