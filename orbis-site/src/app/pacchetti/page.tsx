      ...
      <section className="relative z-1 pt-32 pb-16 px-6 md:px-16 text-center">
        ...
        <div className="relative">
          ...
          <p className="text-sm text-[var(--color-muted)]">
            ...
            <Link href="/discord" className="text-[var(--color-discord)] no-underline hover:underline">Discord</Link>
            {" · "}
            <Link href="/telegram" className="text-[var(--color-telegram)] no-underline hover:underline">Telegram</Link>
            {" · "}
            <Link href="/app-mobile" className="text-[var(--color-cyan)] no-underline hover:underline">App Mobile</Link>
          </p>
        </div>
      </section>
