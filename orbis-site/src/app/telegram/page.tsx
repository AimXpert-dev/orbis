...
const features = [
  ...
  },
  {
    ...
    desc: "Configura comandi su misura per il tuo workflow. Flessibilita totale.",
    icon: "🛠️",
  },
];
...
export default function TelegramPage() {
  return (
    <>
      ...
      {/* Features - 2 columns with alternating layout */}
      ...
      <section className="relative z-1 py-20 px-6 md:px-16 border-t border-[var(--color-border)] bg-[var(--color-bg2)]">
        <div className="max-w-[600px] mx-auto text-center">
          ...
          <p className="text-sm text-[var(--color-muted)] mt-6">
            ...
            <Link href="/pacchetti" className="text-[#2AABEE] no-underline hover:underline">
