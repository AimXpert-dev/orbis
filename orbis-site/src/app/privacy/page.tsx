        ...
        <div className="max-w-[860px] mx-auto">
          ...
          <div className="space-y-12 text-[var(--color-muted)] text-[15px] leading-relaxed">
            ...
            <div className="bg-[var(--color-bg2)] border border-[var(--color-border)] rounded-2xl p-8">
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-2.5"><span className="text-[var(--color-cyan)] font-bold mt-0.5">·</span><span><strong className="text-[var(--color-white)]">Esecuzione contrattuale:</strong> erogazione dei servizi Orbis Sistema e Orbis Gestionale, gestione dell'account, supporto tecnico.</span></li>
